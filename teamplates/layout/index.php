    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header navbar-header-my">
                ...
                <a class="navbar-brand" href="index.php">Урок 8.
Мини-Фреймворк для создания сайтов.</a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="/"> Выборка всех объектов недвижимости</a>
                        </li>
                        <li>
                            <a href="/realty/add_line"> Добавление объекта недвижимости</a>
                        </li>
						<?if(isset($role))
						{
							if($role == 10)
